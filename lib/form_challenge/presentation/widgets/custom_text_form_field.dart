...
import 'autocomplete_address_widget.dart';
...
class CustomTextFormField extends StatefulWidget {
  ...
  final AutoCompleteInfo? autoCompleteInfo;
  @override
...
class _State extends State<CustomTextFormField> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.autoCompleteInfo != null
        ? AutoCompleteAddressOverlay(
            onAddressSelected: widget.autoCompleteInfo!.onSelectedItem,
            focusNode: _focusNode,
            child: textFormField,
          )
        : textFormField;
